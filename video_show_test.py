...
class Ui_VideoWindow(object):
    def setupUi(self, VideoWindow):
        ...
        self.origin_video.setGeometry(600, 400, 1200, 800)

        # 创建播放按钮
        self.play_button = QPushButton(self.centralwidget)
        self.play_button.setObjectName(u"play_button")
        self.play_button.setGeometry(50, 20, 75, 30)
    ...
    def retranslateUi(self, VideoWindow):
        ...
        self.play_button.setText(QCoreApplication.translate("MainWindow", u"\u8fd4\u56de\u4e0a\u4e00", None))
    # retranslateUi
